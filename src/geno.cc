...
param_creation_geno geno_param_init(int argc, char *argv[])
{
	...
	geno_param.chrlens_filename = geno_param.path_temp + "/" + geno_param.prefix + ".chrlens";
	geno_param.snp_dict_filename = geno_param.path_temp + "/" + geno_param.prefix + "SmartDict" + geno_param.name;
	
	//std::cerr << geno_param.snp_dict_filename << std::endl;

	std::string path_index_reassembly_snp = geno_param.path_temp+"/" + geno_param.prefix + "Reassembly" + geno_param.name;
	std::string path_index_ref_genome = geno_param.path_temp+"/" + geno_param.reference;
